import { ColorSpecification, DataDrivenPropertyValueSpecification, ExpressionType, FilterSpecification, LineLayerSpecification, PropertyValueSpecification } from 'maplibre-gl'
...
type MaplibreColor = {"line-color": DataDrivenPropertyValueSpecification<ColorSpecification>};
type Visbility = {"line-opacity": DataDrivenPropertyValueSpecification<number>};
type LineWidth = {"line-width"?: DataDrivenPropertyValueSpecification<number>};
...
export function widthFromStatus(widthAtZoom10: number, widthAtZoom10Narrow: number, widthAtZoom15: number, widthAtZoom15Narrow: number): LineWidth {
  return {
    "line-width": [
      "interpolate",
      ["linear"],
      ["zoom"],
      10, [ "match", ["get", "status"],
        [TronçonStatus.Planned, TronçonStatus.Blocked], widthAtZoom10Narrow,
        widthAtZoom10,
      ],
      15, [ "match", ["get", "status"],
        [TronçonStatus.Planned, TronçonStatus.Blocked], widthAtZoom15Narrow,
        widthAtZoom15,
      ],
    ],
  }
