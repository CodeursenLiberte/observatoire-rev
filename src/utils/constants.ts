...
export const moaName: { [index: string]: string } = {
  ...
  "CA Saint-Germain Boucles de Seine": "Agglomération Saint-Germain Boucles de Seine",
  ...
  "CHARENTON-LE-PONT/CD94/DIRIF": "Ville de Charenton-Le-Pont/Département du Val-de-Marne/Direction des routes d’Île-de-France (DIRIF)",
  "CHARENTON-LE-PONT/VNF": "Ville de Charenton-Le-Pont/Voies Navigables de France ",
  ...
  "EPA France": "Établissement public d’aménagement France (EpaFrance) (Aménageur national)",
  "EPA PARIS SACLAY": "Établissement public d’aménagement Paris-Saclay (EPAPS) (Aménageur régional)",
  "EPAFRANCE": "Établissement public d’aménagement France (EpaFrance) (Aménageur national)",
  "EPAMARNE": "Établissement public d’aménagement Marne (EpaMarne) (Aménageur régional)",
  ...
  "SAINT-GERMAIN BOUCLES DE SEINE": "Agglomération Saint-Germain Boucles de Seine",
  ...
  "SIAAP": "Service interdépartemental pour l’assainissement de l’agglomération parisienne (SIAAP)",
  "SNCF": "SNCF",
